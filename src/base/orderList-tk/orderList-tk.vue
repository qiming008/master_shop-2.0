  ...
  <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
    ...
    <ul>
      <van-list :loading="loading"
        ...
        :offset="100"
      >
      <li @click="go_info(item)" v-for="item in cont" :key="item.id">
        <p class="shop_name">
          ...
          <!--add-->
          <span class="shop_name_r" v-else-if="(item.orderRefund.suo==0||item.orderRefund.suo==3)&&item.orderRefund.status==10">退货已寄回</span>
        </p>
