  ...
  <transition name="fade">
    <div class="refund">
      ...
      <div class="refund_box" v-if="info">
        <div class="shop" v-for="item in info" :key="item.id">
...
export default {
  ...
  mounted(){
    console.log(this.info[0].orderRefund)
  },
  methods: {
    sure() { // 确认退款
      ...
      axios.get(`/api/order/refund/update/express?id=${this.info[0].orderRefund.id}&express_name=${this.kdgs}&express_num=${this.kddh}&tel=${this.lxfs}`)
      .then((res) => {
